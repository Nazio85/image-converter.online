    ...
    <v-row align="center" justify="center">
        ...
        <v-col lg="11" sm="12" offset-lg="1" class="mt-5">
            <v-row align="center" justify="start">
                <v-col lg="8">
                    <h1 class="text--primary" color="primary">Simple package convert images without limits</h1>
                    <p>
                        Использование th:text и многоязычность текста. Многоязычный текст представлен вне файлов
                        шаблонов и хранится в отдельных файлах (обычно в файлах .properties) и его можно легко заменить
